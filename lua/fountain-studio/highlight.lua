...
M.groups = {
  ...
  FountainNote = {},
  FountainBoneyard = {},
  FountainOutlineHeader = { bold = true },
  FountainOutlineNumber = {},
  FountainOutlineHeading = {},
  FountainOutlineLength = {},
  FountainOutlineSection = { bold = true },
  FountainOutlineCurrent = {},
  FountainOutlineEmpty = { italic = true },
  FountainRuler = {},
  FountainRulerCurrent = { bold = true },
  FountainInspectorHeader = { bold = true },
  FountainInspectorSlug = { bold = true },
  FountainInspectorText = {},
  FountainInspectorNote = {},
  FountainInspectorCharacter = {},
  FountainInspectorDim = { italic = true },
...
M.links = {
  ...
  FountainOutlineHeader = "Comment",
  FountainOutlineNumber = "LineNr",
  FountainOutlineHeading = "Normal",
  FountainOutlineLength = "Comment",
  FountainOutlineSection = "Title",
  FountainOutlineCurrent = "CursorLine",
  FountainOutlineEmpty = "Comment",
  FountainRuler = "NonText",
  FountainRulerCurrent = "Comment",
  FountainInspectorHeader = "Comment",
  FountainInspectorSlug = "Title",
  FountainInspectorText = "Normal",
  FountainInspectorNote = "Comment",
  FountainInspectorCharacter = "Identifier",
  FountainInspectorDim = "Comment",
